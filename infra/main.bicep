...
// Pass the names of the webapi and app service plan to the module.
param webapiName string = 'BOSS_AI_API' 
...
// Create an App Service and App Service Plan for the webapi service.
